...
class SBValue:
    ...
    def get_child_access_object(self) -> children_acess:
...
ATA
    ...
    LLDB_OPT_SET_1 = 1
    LLDB_OPT_SET_10 = 512
    LLDB_OPT_SET_11 = 1024
    LLDB_OPT_SET_12 = 2048
    LLDB_OPT_SET_2 = 2
    LLDB_OPT_SET_3 = 4
    LLDB_OPT_SET_4 = 8
    LLDB_OPT_SET_5 = 16
    ...
    eArgTypeFileLineColumn = 20
    eArgTypeFilename = 21
    eArgTypeFormat = 22
    eArgTypeFrameIndex = 23
    eArgTypeFullName = 24
    eArgTypeFunctionName = 25
    eArgTypeFunctionOrSymbol = 26
    eArgTypeGDBFormat = 27
    eArgTypeHelpText = 28
    eArgTypeIndex = 29
    eArgTypeLanguage = 30
    eArgTypeLastArg = 89
    eArgTypeLineNum = 31
    eArgTypeLogCategory = 32
    eArgTypeLogChannel = 33
    eArgTypeMethod = 34
    eArgTypeModuleUUID = 87
    eArgTypeName = 35
    eArgTypeNewPathPrefix = 36
    eArgTypeNone = 79
    eArgTypeNumLines = 37
    eArgTypeNumberPerLine = 38
    eArgTypeOffset = 39
    eArgTypeOldPathPrefix = 40
    eArgTypeOneLiner = 41
    eArgTypePath = 42
    eArgTypePermissionsNumber = 43
    eArgTypePermissionsString = 44
    eArgTypePid = 45
    eArgTypePlatform = 80
    eArgTypePlugin = 46
    eArgTypeProcessName = 47
    eArgTypePythonClass = 48
    eArgTypePythonFunction = 49
    eArgTypePythonScript = 50
    eArgTypeQueueName = 51
    eArgTypeRegisterName = 52
    eArgTypeRegularExpression = 53
    eArgTypeRunArgs = 54
    eArgTypeRunMode = 55
    eArgTypeSaveCoreStyle = 88
    eArgTypeScriptLang = 57
    eArgTypeScriptedCommandSynchronicity = 56
    eArgTypeSearchWord = 58
    eArgTypeSelector = 59
    eArgTypeSettingIndex = 60
    eArgTypeSettingKey = 61
    eArgTypeSettingPrefix = 62
    eArgTypeSettingVariableName = 63
    eArgTypeShlibName = 64
    eArgTypeSortOrder = 66
    eArgTypeSourceFile = 65
    eArgTypeStartAddress = 67
    eArgTypeSummaryString = 68
    eArgTypeSymbol = 69
    eArgTypeThreadID = 70
    eArgTypeThreadIndex = 71
    eArgTypeThreadName = 72
    eArgTypeTypeName = 73
    eArgTypeUnixSignal = 75
    eArgTypeUnsignedInteger = 74
    eArgTypeValue = 77
    eArgTypeVarName = 76
    eArgTypeWatchType = 83
    eArgTypeWatchpointID = 81
    eArgTypeWatchpointIDRange = 82
    eArgTypeWidth = 78
    eBasicTypeBool = 20
    eBasicTypeChar = 2
    eBasicTypeChar16 = 8
    ...
    eBreakpointEventTypeAutoContinueChanged = 4096
    ...
    eByteOrderLittle = 4
    eByteOrderPDP = 2
    eCommandInterpreterResultCommandError = 2
    eCommandInterpreterResultInferiorCrash = 1
    eCommandInterpreterResultQuitRequested = 3
    eCommandInterpreterResultSuccess = 0
    eCommandProcessMustBeLaunched = 64
    eCommandProcessMustBePaused = 128
    eCommandProcessMustBeTraced = 256
    ...
    eLaunchFlagExec = 1
    eLaunchFlagInheritTCCFromParent = 4096
    ...
    eNoDynamicValues = 0
    eNumInstrumentationRuntimeTypes = 5
    ...
    eScriptLanguageLua = 2
    eScriptLanguageNone = 0
    eScriptLanguagePython = 1
    eScriptLanguageUnknown = 3
    eSearchDepthAddress = 6
    eSearchDepthBlock = 5
    eSearchDepthCompUnit = 3
    eSearchDepthFunction = 4
    eSearchDepthInvalid = 0
    eSearchDepthModule = 2
    eSearchDepthTarget = 1
    eSectionTypeARMexidx = 39
    eSectionTypeARMextab = 40
    eSectionTypeAbsoluteAddress = 43
    eSectionTypeCode = 1
    eSectionTypeCompactUnwind = 41
    eSectionTypeContainer = 2
    eSectionTypeDWARFAppleNames = 30
    eSectionTypeDWARFAppleNamespaces = 32
    eSectionTypeDWARFAppleObjC = 33
    eSectionTypeDWARFAppleTypes = 31
    eSectionTypeDWARFDebugAbbrev = 15
    eSectionTypeDWARFDebugAbbrevDwo = 51
    eSectionTypeDWARFDebugAddr = 16
    eSectionTypeDWARFDebugAranges = 17
    eSectionTypeDWARFDebugCuIndex = 18
    eSectionTypeDWARFDebugFrame = 19
    eSectionTypeDWARFDebugInfo = 20
    eSectionTypeDWARFDebugInfoDwo = 52
    eSectionTypeDWARFDebugLine = 21
    eSectionTypeDWARFDebugLineStr = 48
    eSectionTypeDWARFDebugLoc = 22
    eSectionTypeDWARFDebugLocDwo = 57
    eSectionTypeDWARFDebugLocLists = 50
    eSectionTypeDWARFDebugLocListsDwo = 58
    eSectionTypeDWARFDebugMacInfo = 23
    eSectionTypeDWARFDebugMacro = 24
    eSectionTypeDWARFDebugNames = 46
    eSectionTypeDWARFDebugPubNames = 25
    eSectionTypeDWARFDebugPubTypes = 26
    eSectionTypeDWARFDebugRanges = 27
    eSectionTypeDWARFDebugRngLists = 49
    eSectionTypeDWARFDebugRngListsDwo = 56
    eSectionTypeDWARFDebugStr = 28
    eSectionTypeDWARFDebugStrDwo = 53
    eSectionTypeDWARFDebugStrOffsets = 29
    eSectionTypeDWARFDebugStrOffsetsDwo = 54
    eSectionTypeDWARFDebugTuIndex = 59
    eSectionTypeDWARFDebugTypes = 45
    eSectionTypeDWARFDebugTypesDwo = 55
    eSectionTypeDWARFGNUDebugAltLink = 44
    eSectionTypeData = 3
    ...
    eSectionTypeEHFrame = 38
    eSectionTypeELFDynamicLinkInfo = 37
    eSectionTypeELFDynamicSymbols = 35
    eSectionTypeELFRelocationEntries = 36
    eSectionTypeELFSymbolTable = 34
    eSectionTypeGoSymtab = 42
    eSectionTypeInvalid = 0
    eSectionTypeOther = 47
    ...
    eStopReasonProcessorTrace = 11
    eStopReasonSignal = 5
    eStopReasonThreadExiting = 9
    eStopReasonTrace = 2
    eStopReasonVFork = 13
    eStopReasonVForkDone = 14
    eStopReasonWatchpoint = 4
    eStopShowColumnAnsi = 1
    eStopShowColumnAnsiOrCaret = 0
    eStopShowColumnCaret = 2
    eStopShowColumnNone = 3
    eStructuredDataTypeArray = 2
    eStructuredDataTypeBoolean = 5
    eStructuredDataTypeDictionary = 7
    eStructuredDataTypeFloat = 4
    eStructuredDataTypeGeneric = 1
    eStructuredDataTypeInteger = 3
    eStructuredDataTypeInvalid = -1
    eStructuredDataTypeNull = 0
    eStructuredDataTypeString = 6
    ...
    eTemplateArgumentKindNullPtr = 8
    ...
    eTraceInstructionControlFlowTypeBranch = 4
    eTraceInstructionControlFlowTypeCall = 16
    eTraceInstructionControlFlowTypeInstruction = 2
    eTraceInstructionControlFlowTypeReturn = 32
    eTraceInstructionControlFlowTypeTakenBranch = 8
    eTraceTypeNone = 0'
    eTraceTypeProcessorTrace = 1
    eTypeClassAny = -1
    eTypeClassArray = 1
    ...
    eTypeOptionFrontEndWantsDereference = 512
    ...
    eWatchpointKindRead = 2
    eWatchpointKindWrite = 1
    frame = <lldb.SBFrame; proxy of <Swig Object of type 'lldb::SBFrame *'...
    kLastSearchDepthKind = 6
    kLastStateType = 11
